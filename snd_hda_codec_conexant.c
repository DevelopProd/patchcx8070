 ...
 *
 * Патч адаптирован для Acer Aspire A15-41M (CX8070)
 */
...
static const struct hda_quirk cxt5066_fixups[] = {
        // Добавлена поддержка Acer Aspire A15-41M
        SND_PCI_QUIRK(0x1025, 0x080d, "Acer Aspire A15-41M", CXT_FIXUP_STEREO_DMIC),
...
static int patch_conexant_auto(struct hda_codec *codec)
{
        ...
        /* init cx8070/sn6140 flag for Acer Aspire A15-41M */
        if (codec->core.vendor_id == 0x14f11f86) {
